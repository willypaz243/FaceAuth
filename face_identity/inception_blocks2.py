...
def inception_block_1a(hidden_layer):
    ...
    layer_3x3 = keras.layers.BatchNormalization(name = 'inception_3a_3x3_bn1')(layer_3x3)
    ...
    layer_3x3 = keras.layers.BatchNormalization(name='inception_3a_3x3_bn2')(layer_3x3)
    layer_3x3 = keras.layers.Activation('relu')(layer_3x3)
    # ===========================================================
    # 5x5========================================================
    layer_5x5 = keras.layers.Conv2D(16, (1, 1), kernel_initializer=initializer, name='inception_3a_5x5_conv1')(hidden_layer)
    layer_5x5 = keras.layers.BatchNormalization(name='inception_3a_5x5_bn1')(layer_5x5)
    ...
    layer_5x5 = keras.layers.BatchNormalization(name='inception_3a_5x5_bn2')(layer_5x5)
    layer_5x5 = keras.layers.Activation('relu')(layer_5x5)
    # ===========================================================
    # Pool=======================================================
    ...
    layer_pool = keras.layers.BatchNormalization(name='inception_3a_pool_bn')(layer_pool)
    ...
    layer_1x1 = keras.layers.BatchNormalization(name='inception_3a_1x1_bn')(layer_1x1)
...
def inception_block_1b(hidden_layer):
    ...
    layer_pool = keras.layers.BatchNormalization(name='inception_3b_pool_bn')(layer_pool)
    layer_pool = keras.layers.Activation('relu')(layer_pool)
    ...
    layer_1x1 = keras.layers.BatchNormalization(name='inception_3b_1x1_bn')(layer_1x1)
    layer_1x1 = keras.layers.Activation('relu')(layer_1x1)
    # ===========================================================
...
def conv2d_bn(
    ...
    tensor = keras.layers.BatchNormalization(name=layer_name+'_bn'+num)(tensor)
    ...
    tensor = keras.layers.BatchNormalization(name=layer_name+'_bn'+'2')(tensor)
    tensor = keras.layers.Activation('relu')(tensor)
